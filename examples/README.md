# SEO Data Scraper API - Examples

This folder contains example code for using the SEO Data Scraper API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/seoscraper',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/seoscraper");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/seoscraper](https://docs.apiverve.com/ref/seoscraper)
