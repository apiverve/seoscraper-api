/*
 * SEO Data Scraper API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the SEO Data Scraper API.
 * API Documentation: https://docs.apiverve.com/ref/seoscraper
 */
...
{
    class SEODataScraperExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/seoscraper";

        /// <summary>
        /// Make a POST request to the SEO Data Scraper API
        /// </summary>
        static async Task<JsonDocument> CallSEODataScraperAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling SEO Data Scraper API...\n");

            var result = await CallSEODataScraperAPI();
