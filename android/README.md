...
```gradle
dependencies {
    implementation 'com.github.apiverve:seoscraper-api:1.1.12'
}
```
...
```java
import com.apiverve.seoscraper.SEODataScraperAPIClient;
import com.apiverve.seoscraper.APIResponse;
import com.apiverve.seoscraper.APIException;

// Initialize the client
SEODataScraperAPIClient client = new SEODataScraperAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/seoscraper](https://docs.apiverve.com/ref/seoscraper)
...
- **Documentation:** [https://docs.apiverve.com/ref/seoscraper](https://docs.apiverve.com/ref/seoscraper)
- **Issues:** [GitHub Issues](https://github.com/apiverve/seoscraper-api/issues)
