...
const (
	baseURL        = "https://api.apiverve.com/v1/seoscraper"
	defaultTimeout = 30 * time.Second
)

// Client is the SEO Data Scraper API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new SEO Data Scraper API client.
...
// Execute makes a request to the SEO Data Scraper API with typed parameters.
//
